...
public:
	...
	class UUserWidget* GetTutorialWindowWidget() const;
	void SetTutorialWindowWidget(TSubclassOf<class UUserWidget> NewWindowWidgetClass);
...
private:
	...
	UPROPERTY()
	class UUserWidget* TutorialWindowWidget;
